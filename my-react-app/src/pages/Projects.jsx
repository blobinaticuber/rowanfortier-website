        ...
        <>
            <h1>Projects</h1>
                ...
                <div className="grid">
                    ...
                    <Card color="var(--pink)">
                        <ImageShape border shape="circle" path="/public/projects/helloStarsLogo.png"/>
                ...
                <div className="grid">
                    ...
                    <Card link="https://hypercubing.xyz/" color="var(--purple)">
                        <ImageShape shape="squircle" path="/public/projects/HSC2.svg"/>
                        <div className="vstack">
                    ...
                    <Card link="https://github.com/blobinaticuber/3x3x3-simulator" color="var(--gray)">
                        <ImageShape border shape="squircle" path="/public/projects/processing-3x3x3.png"/>
                        <div className="vstack">
